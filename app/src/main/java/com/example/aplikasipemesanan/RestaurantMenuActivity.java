...
import com.example.aplikasipemesanan.adapters.MenuListAdapter;
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(RestaurantMenuActivity.this, "Silahkan Tambahkan beberapa item di keranjang.", Toast.LENGTH_SHORT).show();
                    return;
                }
                else if(itemsInCartList == null) {
                    Toast.makeText(RestaurantMenuActivity.this, "Silahkan Tambahkan beberapa item di keranjang.", Toast.LENGTH_SHORT).show();
                    return;
                }
                restaurantModel.setMenus(itemsInCartList);
                Intent i = new Intent(RestaurantMenuActivity.this, PlaceOrderActivity.class);
    ...
    public void onAddToCartClick(Menu menu) {
        ...
        buttonCheckout.setText("Pesanan (" +totalItemInCart +") item");
    }
