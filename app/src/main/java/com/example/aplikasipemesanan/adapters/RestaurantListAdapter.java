...
//        holder.restaurantAddress.setText("Address: "+restaurantModelList.get(position));
//        holder.restaurantAddress.setText("Address: "+restaurantModelList.get(position).getAddress());
//        holder.restaurantHours.setText("Today's hours: " + restaurantModelList.get(position));
